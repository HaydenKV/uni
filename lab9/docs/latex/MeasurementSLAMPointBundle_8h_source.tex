...
\DoxyCodeLine{00051\ \ \ \ \ \textcolor{comment}{//\ Transform\ nav\ →\ camera:\ rPCc\ =\ Rcn\ *\ (rPNn\ -\/\ rCNn),\ with\ Rcn\ =\ Rncᵀ}}
\DoxyCodeLine{00052\ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Matrix3<Scalar>\ Rcn\ =\ Tnc.\mbox{\hyperlink{structPose_a9e7f838356fc6b576abaf2faef09f2b0}{rotationMatrix}}.transpose();}
\DoxyCodeLine{00053\ \ \ \ \ Eigen::Vector3<Scalar>\ rPCc\ =\ Rcn\ *\ (rPNn\ -\/\ Tnc.\mbox{\hyperlink{structPose_a82049e6f7167af41a80c29631ae9a9d3}{translationVector}});}
\DoxyCodeLine{00054\ \ \ \ \ \textcolor{comment}{//\ TODO:\ Lab\ 8}}
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \ \ \ \ \textcolor{comment}{//\ Pixel\ coordinates}}
\DoxyCodeLine{00057\ \ \ \ \ Eigen::Vector2<Scalar>\ rQOi\ =\ camera\_.vectorToPixel(rPCc);}
\DoxyCodeLine{00058\ \ \ \ \ \textcolor{comment}{//\ TODO:\ Lab\ 8}}
\DoxyCodeLine{00059\ \ \ \ \ \textcolor{keywordflow}{return}\ rQOi;}
\DoxyCodeLine{00060\ \}}
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00062\ \textcolor{comment}{//\ Image\ feature\ locations\ for\ a\ bundle\ of\ landmarks}}
\DoxyCodeLine{00063\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ Scalar>}
\DoxyCodeLine{00064\ Eigen::VectorX<Scalar>\ MeasurementPointBundle::predictFeatureBundle(\textcolor{keyword}{const}\ Eigen::VectorX<Scalar>\ \&\ x,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classSystemSLAM}{SystemSLAM}}\ \&\ system,\ \textcolor{keyword}{const}\ std::vector<std::size\_t>\ \&\ idxLandmarks)\textcolor{keyword}{\ const}}
\DoxyCodeLine{00065\ \textcolor{keyword}{}\{}
\DoxyCodeLine{00066\ \ \ \ \ assert(x.size()\ ==\ system.\mbox{\hyperlink{classSystemEstimator_a3459a820d965e53e8984ffdf800ef790}{density}}.\mbox{\hyperlink{classGaussianInfo_ac726ca2019576d3297070b77607acb83}{dim}}());}
\DoxyCodeLine{00067\ }
\DoxyCodeLine{00068\ \ \ \ \ \textcolor{keyword}{const}\ std::size\_t\ \&\ nL\ =\ idxLandmarks.size();}
\DoxyCodeLine{00069\ \ \ \ \ Eigen::VectorX<Scalar>\ h(2*nL);}
\DoxyCodeLine{00070\ \ \ \ \ \textcolor{keywordflow}{for}\ (std::size\_t\ i\ =\ 0;\ i\ <\ nL;\ ++i)}
\DoxyCodeLine{00071\ \ \ \ \ \{}
\DoxyCodeLine{00072\ \ \ \ \ \ \ \ \ Eigen::Vector2<Scalar>\ rQOi\ =\ predictFeature(x,\ system,\ idxLandmarks[i]);}
\DoxyCodeLine{00073\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Set\ pair\ of\ elements\ of\ h}}
\DoxyCodeLine{00074\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO:\ Lab\ 9}}
