/**
 * @file Pose.hpp
 * @brief Defines the Pose class for representing and manipulating 3D poses in \f$\mathsf{SE}(3)\f$
 * 
 * This file contains the definition of the Pose class, which represents
 * 3D poses as elements of the Special Euclidean group \f$\mathsf{SE}(3)\f$. It provides
 * functionality for pose composition, point transformation, and conversion
 * between different representations (Eigen and OpenCV).
 * 
 * @see Pose
 */
