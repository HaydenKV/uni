...
\DoxyCodeLine{00026\ \textcolor{comment}{//\#include\ <Eigen/LU>\ //\ TODO:\ Remove\ this\ header\ after\ fixing\ GaussianInfo::affineTransform\ to\ pass\ all\ unit\ tests}}
...
\DoxyCodeLine{00422\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO}}
...
\DoxyCodeLine{00431\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO}}
...
\DoxyCodeLine{00499\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO}}
...
\DoxyCodeLine{00508\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO}}
...
\DoxyCodeLine{00513\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO}}
...
\DoxyCodeLine{00613\ }
\DoxyCodeLine{00614\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Numerical\ rank\ threshold:\ tol\ =\ max(m,n)\ *\ eps\ *\ max(s)}}
\DoxyCodeLine{00615\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Scalar\ tol\ =\ std::max(m,\ n)\ *\ Eigen::NumTraits<Scalar>::epsilon()\ *\ (s.size()\ ?\ s.maxCoeff()\ :\ Scalar(0));}
\DoxyCodeLine{00616\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ r\ =\ (s.array()\ >\ tol).count();\ \ \ \ \ \ \ \textcolor{comment}{//\ MATLAB:\ r\ =\ nnz(s\ >\ tol);}}
\DoxyCodeLine{00617\ }
\DoxyCodeLine{00618\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Partitions\ matching\ MATLAB\ slices}}
\DoxyCodeLine{00619\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::MatrixX<Scalar>\ U1\ =\ U.leftCols(r);}
\DoxyCodeLine{00620\ \ \ \ \ \ \ \ \ Eigen::MatrixX<Scalar>\ U2;\ U2.resize(m,\ m\ -\/\ r);\ \textcolor{keywordflow}{if}\ (m\ >\ r)\ U2\ =\ U.rightCols(m\ -\/\ r);}
\DoxyCodeLine{00621\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::MatrixX<Scalar>\ V1\ =\ V.leftCols(r);}
\DoxyCodeLine{00622\ \ \ \ \ \ \ \ \ Eigen::MatrixX<Scalar>\ V2;\ V2.resize(n,\ n\ -\/\ r);\ \textcolor{keywordflow}{if}\ (n\ >\ r)\ V2\ =\ V.rightCols(n\ -\/\ r);}
\DoxyCodeLine{00623\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::VectorX<Scalar>\ s1\ =\ s.head(r);}
\DoxyCodeLine{00624\ }
\DoxyCodeLine{00625\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ MATLAB}}
\DoxyCodeLine{00626\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Jp\ =\ (V1./s1(:).')*U1.';\ \ \ \%\ J\string^+\ =\ V1\ *\ diag(1./s1)\ *\ U1.'}}
\DoxyCodeLine{00627\ }
\DoxyCodeLine{00628\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Pseudoinverse\ on\ rank-\/r\ subspace:\ J⁺\ =\ V1\ *\ diag(1./s1)\ *\ U1ᵀ}}
\DoxyCodeLine{00629\ \ \ \ \ \ \ \ \ Eigen::MatrixX<Scalar>\ Jp;}
\DoxyCodeLine{00630\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (r\ >\ 0)\ \{}
\DoxyCodeLine{00631\ \ \ \ \ \ \ \ \ \ \ \ \ Jp\ =\ V1\ *\ s1.cwiseInverse().asDiagonal()\ *\ U1.transpose();\ \textcolor{comment}{//\ n\ x\ m}}
\DoxyCodeLine{00632\ \ \ \ \ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \{}
\DoxyCodeLine{00633\ \ \ \ \ \ \ \ \ \ \ \ \ Jp.resize(n,\ m);}
\DoxyCodeLine{00634\ \ \ \ \ \ \ \ \ \ \ \ \ Jp.setZero();}
\DoxyCodeLine{00635\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00636\ }
\DoxyCodeLine{00637\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ MATLAB}}
\DoxyCodeLine{00638\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ X\ =\ obj.Xi*V2;}}
\DoxyCodeLine{00639\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Y\ =\ obj.Xi*Jp;}}
\DoxyCodeLine{00640\ }
\DoxyCodeLine{00641\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Build\ X\ =\ Xi*V2\ (nullspace\ part)\ and\ Y\ =\ Xi*Jp\ (range\ part)}}
\DoxyCodeLine{00642\ \ \ \ \ \ \ \ \ Eigen::MatrixX<Scalar>\ X;\ X.resize(n,\ n\ -\/\ r);}
\DoxyCodeLine{00643\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (V2.cols()\ >\ 0)\ X\ =\ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}\ *\ V2;\ \textcolor{keywordflow}{else}\ X.setZero();}
\DoxyCodeLine{00644\ \ \ \ \ \ \ \ \ Eigen::MatrixX<Scalar>\ Y\ =\ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}\ *\ Jp;\ \textcolor{comment}{//\ n\ x\ m}}
\DoxyCodeLine{00645\ }
\DoxyCodeLine{00646\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ MATLAB}}
\DoxyCodeLine{00647\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ sigma\_max\_ub\ =\ realsqrt(sum([X,\ Y].\string^2,\ 'all'));\ \%\ Cheap\ upper\ bound\ for\ the\ largest\ singular\ value\ of\ [X,\ Y]}}
\DoxyCodeLine{00648\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ kappa\ =\ 1e7*sigma\_max\_ub;\ \ \ \%\ Constraint\ information\ factor\ (kappa\ >>\ sigma\_max\_ub)}}
\DoxyCodeLine{00649\ }
\DoxyCodeLine{00650\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Constraint\ scaling:\ kappa\ >>\ ||[X\ Y]||\ (cheap\ upper\ bound\ via\ Frobenius\ norm)}}
\DoxyCodeLine{00651\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Scalar\ sigma\_max\_ub\ =\ std::sqrt((X.array().square().sum())\ +\ (Y.array().square().sum()));}
\DoxyCodeLine{00652\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Scalar\ kappa\ =\ std::max<Scalar>(Scalar(1e7)\ *\ sigma\_max\_ub,\ Scalar(1e-\/3));\ \textcolor{comment}{//\ floor\ to\ keep\ constraints\ active\ same\ as\ MATLAB}}
\DoxyCodeLine{00653\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ const\ Scalar\ kappa\ =\ (sigma\_max\_ub\ >\ Scalar(0))\ ?\ Scalar(1e7)\ *\ sigma\_max\_ub\ :\ Scalar(1);}}
\DoxyCodeLine{00654\ }
\DoxyCodeLine{00655\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ MATLAB}}
\DoxyCodeLine{00656\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ RR\ =\ qr([X,\ Y,\ obj.nu\ +\ Y*b;\ ...}}
\DoxyCodeLine{00657\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ zeros(m\ -\/\ r,\ n\ -\/\ r),\ kappa*U2.',\ kappa*U2.'*b]);}}
\DoxyCodeLine{00658\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \%\ Q-\/less\ QR\ yields}}
\DoxyCodeLine{00659\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \%\ [R1,\ R2,\ nu1;}}
\DoxyCodeLine{00660\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \%\ \ \ 0,\ R3,\ nu2]}}
\DoxyCodeLine{00661\ }
\DoxyCodeLine{00662\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ C++:\ assemble\ the\ augmented\ matrix\ exactly\ the\ same\ way}}
\DoxyCodeLine{00663\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ rows\ =\ (n\ -\/\ r)\ +\ m;}
\DoxyCodeLine{00664\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ cols\ =\ (n\ -\/\ r)\ +\ m\ +\ 1;}
\DoxyCodeLine{00665\ \ \ \ \ \ \ \ \ Eigen::MatrixX<Scalar>\ A(rows,\ cols);}
\DoxyCodeLine{00666\ \ \ \ \ \ \ \ \ A.setZero();}
\DoxyCodeLine{00667\ }
\DoxyCodeLine{00668\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Top\ block\ (n\ rows)}}
\DoxyCodeLine{00669\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (X.cols()\ >\ 0)\ A.block(0,\ 0,\ \ \ \ \ \ n,\ n\ -\/\ r)\ =\ X;}
\DoxyCodeLine{00670\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ A.block(0,\ n\ -\/\ r,\ \ n,\ \ \ \ \ m)\ =\ Y;}
\DoxyCodeLine{00671\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ A.block(0,\ (n\ -\/\ r)\ +\ m,\ n,\ 1)\ =\ \mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}}\ +\ Y\ *\ b;}
\DoxyCodeLine{00672\ }
\DoxyCodeLine{00673\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Bottom\ block\ ((m\ -\/\ r)\ rows)\ —\ only\ present\ if\ rank-\/deficient\ (m\ >\ r)}}
\DoxyCodeLine{00674\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (m\ >\ r)\ \{}
\DoxyCodeLine{00675\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Left\ block\ already\ zeroed}}
\DoxyCodeLine{00676\ \ \ \ \ \ \ \ \ \ \ \ \ A.block(n,\ n\ -\/\ r,\ \ \ \ \ \ \ m\ -\/\ r,\ m)\ =\ kappa\ *\ U2.transpose();}
\DoxyCodeLine{00677\ \ \ \ \ \ \ \ \ \ \ \ \ A.block(n,\ (n\ -\/\ r)\ +\ m,\ m\ -\/\ r,\ 1)\ =\ kappa\ *\ (U2.transpose()\ *\ b);}
\DoxyCodeLine{00678\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00679\ }
\DoxyCodeLine{00680\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Q-\/less\ QR\ (Eigen:\ obtain\ R\ from\ the\ packed\ QR\ and\ take\ its\ upper-\/triangular\ view)}}
\DoxyCodeLine{00681\ \ \ \ \ \ \ \ \ Eigen::HouseholderQR<Eigen::MatrixX<Scalar>>\ qr(A);}
\DoxyCodeLine{00682\ \ \ \ \ \ \ \ \ Eigen::MatrixX<Scalar>\ R\ =\ qr.matrixQR()}
\DoxyCodeLine{00683\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ .topLeftCorner(rows,\ cols)}
\DoxyCodeLine{00684\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ .template\ triangularView<Eigen::Upper>();}
\DoxyCodeLine{00685\ }
\DoxyCodeLine{00686\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ MATLAB}}
\DoxyCodeLine{00687\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ R3\ =\ RR(n-\/r+1:n-\/r+m,\ n-\/r+1:n-\/r+m);}}
\DoxyCodeLine{00688\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ nu2\ =\ RR(n-\/r+1:n-\/r+m,\ n-\/r+m+1);}}
\DoxyCodeLine{00689\ }
\DoxyCodeLine{00690\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Read\ off\ the\ bottom-\/right\ (m\ x\ m)\ block\ and\ RHS\ following\ the\ Y-\/columns\ region.}}
\DoxyCodeLine{00691\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ row0\ =\ (n\ -\/\ r);\ \ \ \textcolor{comment}{//\ start\ row\ for\ the\ y-\/block}}
\DoxyCodeLine{00692\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ col0\ =\ (n\ -\/\ r);\ \ \ \textcolor{comment}{//\ first\ y-\/column\ in\ A\ (i.e.,\ where\ Y\ starts)}}
\DoxyCodeLine{00693\ \ \ \ \ \ \ \ \ Eigen::MatrixX<Scalar>\ R3\ =\ R.block(row0,\ col0,\ m,\ m);}
\DoxyCodeLine{00694\ \ \ \ \ \ \ \ \ Eigen::VectorX<Scalar>\ \ nu2\ =\ R.block(row0,\ col0\ +\ m,\ m,\ 1);}
\DoxyCodeLine{00695\ }
\DoxyCodeLine{00696\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Return\ p(y)\ =\ N\string^\{-\/1/2\}(y;\ nu2,\ R3)}}
\DoxyCodeLine{00697\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classGaussianInfo_ae54baf9bb8cc663c7effd9bb3ab4ae25}{GaussianInfo}}\ out(m);}
\DoxyCodeLine{00698\ \ \ \ \ \ \ \ \ out.\mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}\ =\ R3;\ \ \ \textcolor{comment}{//\ upper-\/triangular\ by\ construction}}
\DoxyCodeLine{00699\ \ \ \ \ \ \ \ \ out.\mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}}\ =\ nu2;}
\DoxyCodeLine{00700\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ out;\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00701\ }
\DoxyCodeLine{00702\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/\ template\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{00703\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ //\ Linearise\ y\ =\ h(x)\ about\ x\ =\ mux}}
\DoxyCodeLine{00704\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ //\ y\ \string~=\ h(mux)\ +\ J*(x\ -\/\ mux)}}
\DoxyCodeLine{00705\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ //\ \ \ \ =\ J*x\ +\ h(mux)\ -\/\ J*mux}}
\DoxyCodeLine{00706\ }
\DoxyCodeLine{00707\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ //\ Solve\ Y*J\ =\ Xi\ for\ Y}}
\DoxyCodeLine{00708\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ //\ Y\ =\ Xi*inv(J)\ =\ (inv(J.')*Xi.').'}}
\DoxyCodeLine{00709\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Eigen::MatrixX<Scalar>\ Y\ =\ J.transpose().lu().solve(Xi\_.transpose()).transpose();}}
\DoxyCodeLine{00710\ }
\DoxyCodeLine{00711\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ //\ Form\ [Y,\ nu]}}
\DoxyCodeLine{00712\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Eigen::MatrixX<Scalar>\ RR(n,\ n\ +\ 1);}}
\DoxyCodeLine{00713\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ RR\ <<\ Y,\ nu\_;}}
\DoxyCodeLine{00714\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ //\ Q-\/less\ QR\ yields}}
\DoxyCodeLine{00715\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ //\ [R,\ r]}}
\DoxyCodeLine{00716\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Eigen::HouseholderQR<Eigen::Ref<Eigen::MatrixX<Scalar>>>\ qr(RR);\ \ \ \ \ \ \ \ //\ In-\/place\ QR\ decomposition}}
\DoxyCodeLine{00717\ }
\DoxyCodeLine{00718\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ //\ p(y)\ =\ N\string^-\/0.5(y;\ r\ +\ R*(h(mux)\ -\/\ J*mux),\ R)}}
\DoxyCodeLine{00719\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ GaussianInfo\ out(m);}}
\DoxyCodeLine{00720\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ out.Xi\_\ =\ RR.leftCols(m).template\ triangularView<Eigen::Upper>();}}
\DoxyCodeLine{00721\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ out.nu\_\ =\ RR.col(m)\ +\ out.Xi\_*(muy\ -\/\ J*mux);}}
\DoxyCodeLine{00722\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ return\ out;\ }}
\DoxyCodeLine{00723\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/\ template\ -\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/-\/}}
\DoxyCodeLine{00724\ \ \ \ \ \}}
\DoxyCodeLine{00725\ }
\DoxyCodeLine{00735\ \ \ \ \ \textcolor{keyword}{virtual}\ Scalar\ \mbox{\hyperlink{classGaussianInfo_a7b86a5080500134ce1ab2bc3bcd8cda3}{log}}(\textcolor{keyword}{const}\ Eigen::VectorX<Scalar>\ \&\ x)\textcolor{keyword}{\ const\ override}}
\DoxyCodeLine{00736\ \textcolor{keyword}{\ \ \ \ }\{}
\DoxyCodeLine{00737\ \ \ \ \ \ \ \ \ assert(x.cols()\ ==\ 1);}
\DoxyCodeLine{00738\ \ \ \ \ \ \ \ \ assert(x.size()\ ==\ \mbox{\hyperlink{classGaussianInfo_ac726ca2019576d3297070b77607acb83}{dim}}());}
\DoxyCodeLine{00739\ }
\DoxyCodeLine{00740\ \ \ \ \ \ \ \ \ \textcolor{keyword}{static}\ \textcolor{keyword}{const}\ Scalar\ halflog2pi\ =\ std::log(2*std::numbers::pi)/2.0;}
\DoxyCodeLine{00741\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO}}
\DoxyCodeLine{00742\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ n\ =\ \mbox{\hyperlink{classGaussianInfo_ac726ca2019576d3297070b77607acb83}{dim}}();}
\DoxyCodeLine{00743\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::VectorX<Scalar>\ r\ =\ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}\ *\ x\ -\/\ \mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}};\ \textcolor{comment}{//\ r\ =\ Xi\ x\ -\/\ nu}}
\DoxyCodeLine{00744\ }
\DoxyCodeLine{00745\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ AI\ suggests\ may\ need\ to\ use\ ADL\ method\ above\ to\ work\ with\ Autodiff\ types\ but\ this\ passes\ tests}}
\DoxyCodeLine{00746\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Scalar\ logdetXi\ =\ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}.diagonal().array().abs().log().sum();}
\DoxyCodeLine{00747\ }
\DoxyCodeLine{00748\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ const\ Scalar\ logdetXi\ =\ Xi\_.diagonal()}}
\DoxyCodeLine{00749\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ .unaryExpr([](const\ Scalar\&\ d)\{\ using\ std::log;\ const\ Scalar\ a\ =\ d>=Scalar(0)?d:-\/d;\ return\ log(a);\ \})}}
\DoxyCodeLine{00750\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ .sum();}}
\DoxyCodeLine{00751\ }
\DoxyCodeLine{00752\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ ℓ(x)\ =\ -\/n/2\ log(2π)\ +\ log|Ξ|\ -\/\ 1/2\ ||r||²}}
\DoxyCodeLine{00753\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ -\/Scalar(n)\ *\ halflog2pi\ +\ logdetXi\ -\/\ Scalar(0.5)\ *\ r.squaredNorm();;}
\DoxyCodeLine{00754\ \ \ \ \ \}}
\DoxyCodeLine{00755\ }
\DoxyCodeLine{00767\ \ \ \ \ Scalar\ \mbox{\hyperlink{classGaussianInfo_a8faeb2e0ddf9335569f070d671b57ead}{log}}(\textcolor{keyword}{const}\ Eigen::VectorX<Scalar>\ \&\ x,\ Eigen::VectorX<Scalar>\ \&\ g)\textcolor{keyword}{\ const}}
\DoxyCodeLine{00768\ \textcolor{keyword}{\ \ \ \ }\{}
\DoxyCodeLine{00769\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Compute\ gradient\ g}}
\DoxyCodeLine{00770\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO}}
\DoxyCodeLine{00771\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ ∇ℓ(x)\ =\ −Ξᵀ(Ξx\ −\ ν)}}
\DoxyCodeLine{00772\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::VectorX<Scalar>\ r\ =\ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}\ *\ x\ -\/\ \mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}};}
\DoxyCodeLine{00773\ }
\DoxyCodeLine{00774\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Resize\ optional,\ eigen\ should\ auto\ size\ it}}
\DoxyCodeLine{00775\ \ \ \ \ \ \ \ \ \textcolor{comment}{//g.resize(dim());}}
\DoxyCodeLine{00776\ }
\DoxyCodeLine{00777\ \ \ \ \ \ \ \ \ g\ =\ -\/\mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}.transpose()\ *\ r;}
\DoxyCodeLine{00778\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classGaussianInfo_a7b86a5080500134ce1ab2bc3bcd8cda3}{log}}(x);}
\DoxyCodeLine{00779\ \ \ \ \ \}}
\DoxyCodeLine{00780\ }
\DoxyCodeLine{00793\ \ \ \ \ Scalar\ \mbox{\hyperlink{classGaussianInfo_a2a6b01e811020154eebe56068d3f84e1}{log}}(\textcolor{keyword}{const}\ Eigen::VectorX<Scalar>\ \&\ x,\ Eigen::VectorX<Scalar>\ \&\ g,\ Eigen::MatrixX<Scalar>\ \&\ H)\textcolor{keyword}{\ const}}
\DoxyCodeLine{00794\ \textcolor{keyword}{\ \ \ \ }\{}
\DoxyCodeLine{00795\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Compute\ Hessian\ H}}
\DoxyCodeLine{00796\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO}}
\DoxyCodeLine{00797\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ ∇²ℓ(x)\ =\ −ΞᵀΞ\ (constant)}}
\DoxyCodeLine{00798\ }
\DoxyCodeLine{00799\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Resize\ optional,\ eigen\ should\ auto\ size\ it}}
\DoxyCodeLine{00800\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ H.resize(dim(),\ dim());}}
\DoxyCodeLine{00801\ }
\DoxyCodeLine{00802\ \ \ \ \ \ \ \ \ H\ =\ -\/\mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}.transpose()\ *\ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}};}
\DoxyCodeLine{00803\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classGaussianInfo_a7b86a5080500134ce1ab2bc3bcd8cda3}{log}}(x,\ g);}
\DoxyCodeLine{00804\ \ \ \ \ \}}
\DoxyCodeLine{00805\ }
\DoxyCodeLine{00816\ \ \ \ \ \mbox{\hyperlink{classGaussianInfo_ae54baf9bb8cc663c7effd9bb3ab4ae25}{GaussianInfo}}\ \mbox{\hyperlink{classGaussianInfo_aaaf2df2bac13852f7d0d2bddab9a1507}{join}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classGaussianInfo_ae54baf9bb8cc663c7effd9bb3ab4ae25}{GaussianInfo}}\ \&\ other)\textcolor{keyword}{\ const}}
\DoxyCodeLine{00817\ \textcolor{keyword}{\ \ \ \ }\{}
\DoxyCodeLine{00818\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ \&\ n1\ =\ \mbox{\hyperlink{classGaussianInfo_ac726ca2019576d3297070b77607acb83}{dim}}();}
\DoxyCodeLine{00819\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ \&\ n2\ =\ other.\mbox{\hyperlink{classGaussianInfo_ac726ca2019576d3297070b77607acb83}{dim}}();}
\DoxyCodeLine{00820\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classGaussianInfo_ae54baf9bb8cc663c7effd9bb3ab4ae25}{GaussianInfo}}\ out(n1\ +\ n2);}
\DoxyCodeLine{00821\ \ \ \ \ \ \ \ \ out.\mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}}\ <<\ \mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}},\ other.\mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}};}
\DoxyCodeLine{00822\ \ \ \ \ \ \ \ \ out.\mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}\ <<\ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}},\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Eigen::MatrixX<Scalar>::Zero(n1,\ n2),}
\DoxyCodeLine{00823\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ Eigen::MatrixX<Scalar>::Zero(n2,\ n1),\ other.\mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}};}
\DoxyCodeLine{00824\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ out;}
\DoxyCodeLine{00825\ \ \ \ \ \}}
\DoxyCodeLine{00826\ }
\DoxyCodeLine{00837\ \ \ \ \ \mbox{\hyperlink{classGaussianInfo_ae54baf9bb8cc663c7effd9bb3ab4ae25}{GaussianInfo}}\ \mbox{\hyperlink{classGaussianInfo_a56371d89ea874f0faca22b6ce49edc2f}{operator*}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classGaussianInfo_ae54baf9bb8cc663c7effd9bb3ab4ae25}{GaussianInfo}}\ \&\ other)\textcolor{keyword}{\ const}}
\DoxyCodeLine{00838\ \textcolor{keyword}{\ \ \ \ }\{}
\DoxyCodeLine{00839\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classGaussianInfo_aaaf2df2bac13852f7d0d2bddab9a1507}{join}}(other);}
\DoxyCodeLine{00840\ \ \ \ \ \}}
\DoxyCodeLine{00841\ }
\DoxyCodeLine{00853\ \ \ \ \ \mbox{\hyperlink{classGaussianInfo_ae54baf9bb8cc663c7effd9bb3ab4ae25}{GaussianInfo}}\ \&\ \mbox{\hyperlink{classGaussianInfo_a9c4e9c5da96b92bae66a41828e6d8838}{operator*=}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classGaussianInfo_ae54baf9bb8cc663c7effd9bb3ab4ae25}{GaussianInfo}}\ \&\ other)}
\DoxyCodeLine{00854\ \ \ \ \ \{}
\DoxyCodeLine{00855\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ \&\ n1\ =\ \mbox{\hyperlink{classGaussianInfo_ac726ca2019576d3297070b77607acb83}{dim}}();}
\DoxyCodeLine{00856\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ \&\ n2\ =\ other.\mbox{\hyperlink{classGaussianInfo_ac726ca2019576d3297070b77607acb83}{dim}}();}
\DoxyCodeLine{00857\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}}.conservativeResize(n1\ +\ n2);}
\DoxyCodeLine{00858\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}}.tail(n2)\ =\ other.\mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}};}
\DoxyCodeLine{00859\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}.conservativeResizeLike(Eigen::MatrixX<Scalar>::Zero(n1\ +\ n2,\ n1\ +\ n2));}
\DoxyCodeLine{00860\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}.bottomRightCorner(n2,\ n2)\ =\ other.\mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}};}
\DoxyCodeLine{00861\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ *\textcolor{keyword}{this};}
\DoxyCodeLine{00862\ \ \ \ \ \}}
\DoxyCodeLine{00863\ }
\DoxyCodeLine{00874\ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{classGaussianInfo_a8a40f20e8d0fde44bdde239eea310540}{isWithinConfidenceRegion}}(\textcolor{keyword}{const}\ Eigen::VectorX<Scalar>\ \&\ x,\ \textcolor{keywordtype}{double}\ nSigma\ =\ 3.0)\textcolor{keyword}{\ const\ override}}
\DoxyCodeLine{00875\ \textcolor{keyword}{\ \ \ \ }\{}
\DoxyCodeLine{00876\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ \&\ n\ =\ \mbox{\hyperlink{classGaussianInfo_ac726ca2019576d3297070b77607acb83}{dim}}();}
\DoxyCodeLine{00877\ \ \ \ \ \ \ \ \ assert(x.size()\ ==\ n);}
\DoxyCodeLine{00878\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO}}
\DoxyCodeLine{00879\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Probability\ mass\ enclosed\ by\ ±nSigma\ in\ 1D,\ extended\ to\ nD\ via\ chi-\/square}}
\DoxyCodeLine{00880\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ c\ =\ 2*Phi(nSigma)\ -\/\ 1\ \ (same\ as\ Phi(nSigma)\ -\/\ Phi(-\/nSigma))}}
\DoxyCodeLine{00881\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\ c\ \ =\ 2.0\ *\ \mbox{\hyperlink{classGaussianBase_a8437c8ae7f2d45391fc68d0e18e3e5e9}{normcdf}}(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(nSigma))\ -\/\ 1.0;}
\DoxyCodeLine{00882\ }
\DoxyCodeLine{00883\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Squared\ radius\ in\ whitened\ coordinates\ (Mahalanobis\string^2\ threshold)}}
\DoxyCodeLine{00884\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\ r2\ =\ \mbox{\hyperlink{classGaussianBase_ad7a08a532a4a4bfef50960e1ceae45c6}{chi2inv}}(c,\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(n));}
\DoxyCodeLine{00885\ }
\DoxyCodeLine{00886\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Whitened\ residual\ w\ =\ Xi*x\ -\/\ nu\ (so\ that\ ||w||\string^2\ =\ (x-\/mu)\string^T\ P\string^\{-\/1\}\ (x-\/mu))}}
\DoxyCodeLine{00887\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::VectorX<Scalar>\ w\ =\ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}\ *\ x\ -\/\ \mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}};}
\DoxyCodeLine{00888\ }
\DoxyCodeLine{00889\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Inside\ if\ the\ squared\ norm\ is\ below\ the\ chi-\/square\ threshold}}
\DoxyCodeLine{00890\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(w.squaredNorm())\ <=\ r2;}
\DoxyCodeLine{00891\ }
\DoxyCodeLine{00892\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ return\ false;}}
\DoxyCodeLine{00893\ \ \ \ \ \}}
\DoxyCodeLine{00894\ }
\DoxyCodeLine{00907\ \ \ \ \ Eigen::Matrix4<Scalar>\ \mbox{\hyperlink{classGaussianInfo_a4b83a7204fbab4539c388e17cdd9e51b}{quadricSurface}}(\textcolor{keywordtype}{double}\ nSigma\ =\ 3.0)\textcolor{keyword}{\ const}}
\DoxyCodeLine{00908\ \textcolor{keyword}{\ \ \ \ }\{}
\DoxyCodeLine{00909\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Index\ \&\ n\ =\ \mbox{\hyperlink{classGaussianInfo_ac726ca2019576d3297070b77607acb83}{dim}}();}
\DoxyCodeLine{00910\ \ \ \ \ \ \ \ \ assert(n\ ==\ 3);}
\DoxyCodeLine{00911\ \ \ \ \ \ \ \ \ }
\DoxyCodeLine{00912\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ 1)\ Compute\ the\ chi-\/square\ radius\string^2\ for\ the\ requested\ n-\/sigma\ mass}}
\DoxyCodeLine{00913\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\ c\ \ =\ 2.0\ *\ \mbox{\hyperlink{classGaussianBase_a8437c8ae7f2d45391fc68d0e18e3e5e9}{normcdf}}(\textcolor{keyword}{static\_cast<}\textcolor{keywordtype}{double}\textcolor{keyword}{>}(nSigma))\ -\/\ 1.0;}
\DoxyCodeLine{00914\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{double}\ r2\ =\ \mbox{\hyperlink{classGaussianBase_ad7a08a532a4a4bfef50960e1ceae45c6}{chi2inv}}(c,\ 3.0);\ \ \textcolor{comment}{//\ DoF\ =\ 3}}
\DoxyCodeLine{00915\ }
\DoxyCodeLine{00916\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ 2)\ Information\ quantities}}
\DoxyCodeLine{00917\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Λ\ =\ Xiᵀ\ Xi\ \ (information\ matrix\ =\ P\string^\{-\/1\})\ (infoMat)}}
\DoxyCodeLine{00918\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ η\ =\ Xiᵀ\ nu\ \ (linear\ term\ in\ the\ expanded\ quadratic)\ (infoVec)}}
\DoxyCodeLine{00919\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Matrix<Scalar,\ 3,\ 3>\ Lambda\ =\ (\mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}.transpose()\ *\ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}).template\ topLeftCorner<3,3>();}
\DoxyCodeLine{00920\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Eigen::Matrix<Scalar,\ 3,\ 1>\ eta\ \ \ \ =\ (\mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}}.transpose()\ *\ \mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}}).template\ head<3>();}
\DoxyCodeLine{00921\ }
\DoxyCodeLine{00922\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ 3)\ Constant\ term:\ nuᵀ\ nu\ −\ r²}}
\DoxyCodeLine{00923\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Scalar\ d\ =\ \textcolor{keyword}{static\_cast<}Scalar\textcolor{keyword}{>}(\mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}}.squaredNorm()\ -\/\ r2);}
\DoxyCodeLine{00924\ }
\DoxyCodeLine{00925\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ 4)\ Assemble\ homogeneous\ quadric:}}
\DoxyCodeLine{00926\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ Q\ =\ [\ \ Λ\ \ \ −η\ ]}}
\DoxyCodeLine{00927\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ \ \ \ \ [\ −ηᵀ\ \ d\ \ ]}}
\DoxyCodeLine{00928\ }
\DoxyCodeLine{00929\ \ \ \ \ \ \ \ \ Eigen::Matrix4<Scalar>\ Q;}
\DoxyCodeLine{00930\ \ \ \ \ \ \ \ \ \textcolor{comment}{//\ TODO}}
\DoxyCodeLine{00931\ \ \ \ \ \ \ \ \ Q.template\ topLeftCorner<3,3>()\ =\ Lambda;}
\DoxyCodeLine{00932\ \ \ \ \ \ \ \ \ Q.template\ topRightCorner<3,1>()\ =\ -\/eta;}
\DoxyCodeLine{00933\ \ \ \ \ \ \ \ \ Q.template\ bottomLeftCorner<1,3>()\ =\ -\/eta.transpose();}
\DoxyCodeLine{00934\ \ \ \ \ \ \ \ \ Q(3,3)\ =\ d;}
\DoxyCodeLine{00935\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ Q;}
\DoxyCodeLine{00936\ \ \ \ \ \}}
\DoxyCodeLine{00937\ }
\DoxyCodeLine{00938\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00939\ \ \ \ \ Eigen::VectorX<Scalar>\ \mbox{\hyperlink{classGaussianInfo_a909812a8835af12e6b58d62558b0b386}{nu\_}};\ }
\DoxyCodeLine{00940\ \ \ \ \ Eigen::MatrixX<Scalar>\ \mbox{\hyperlink{classGaussianInfo_a0722b5d1e1e2d3fe11d8eb3bc6017316}{Xi\_}};\ }
\DoxyCodeLine{00941\ \};}
\DoxyCodeLine{00942\ }
